...
Com base nos protocolos usados nas redes MANET atuais, este trabalho propõe um protocolo
...
\section{Especificações}
	...
	\textit{FDNS-SD}, e suas regras de funcionamento. Inicialmente alguns nomes
	importantes para o protocolo são apresentados, e em seguida os algoritmos do
	protocolo são apresentados.
    ...
    \subsection{Algoritmo de criação de servidores}
        \begin{enumerate}
            ...
            busca em sua vizinhança \ref{vizinhanca} se existe algum servidor de nomes. Se existir,
